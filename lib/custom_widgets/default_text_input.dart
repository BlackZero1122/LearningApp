    ...
    return Visibility(
      ...
      return child;
          ...
          FocusManager.instance.primaryFocus?.unfocus();
            ...
            decoration: InputDecoration(errorStyle: TextStyle(color: Colors.redAccent, fontSize: 12),
              ...
              prefixIcon: icon!=null? Icon(color: enabled?Colors.black:Colors.grey, IconsHelper.map[icon], size: 25):null,
              suffixIcon:suffixicon != null ? 
              Icon(color: enabled?Colors.black:Colors.grey, IconsHelper.map[suffixicon], size: 25):
